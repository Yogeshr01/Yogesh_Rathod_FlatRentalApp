...
@Entity
@Table(name = "Landlords20")
public class Landlord {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "landlrd_seq")
	@SequenceGenerator(name = "landlrd_seq", sequenceName = "landlord_seq", allocationSize = 1)
